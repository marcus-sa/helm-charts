...
{{- include "pnnlmiscscripts.ipmitool.server" . -}}/{{- include "pnnlmiscscripts.ipmitool.prefix" . -}}/{{- include "pnnlmiscscripts.ipmitool.repo" . -}}:{{- include "pnnlmiscscripts.ipmitool.tag" . -}}
{{- end -}}
