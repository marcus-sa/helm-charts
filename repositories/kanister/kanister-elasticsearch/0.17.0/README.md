# `@helm-charts/kanister-kanister-elasticsearch`
...
# Configure profile for elasticsearch, the profile CR is installed in the release namespace
profile:
  create: false
...
- Kanister version 0.17.0 with `profiles.cr.kanister.io` CRD installed
