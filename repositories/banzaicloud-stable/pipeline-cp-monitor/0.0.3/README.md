# `@helm-charts/banzaicloud-stable-pipeline-cp-monitor`

Monitoring chart to deploy on the control-plane of a Pipeline installation

| Field               | Value               |
| ------------------- | ------------------- |
| Repository Name     | banzaicloud-stable  |
| Chart Name          | pipeline-cp-monitor |
| Chart Version       | 0.0.3               |
