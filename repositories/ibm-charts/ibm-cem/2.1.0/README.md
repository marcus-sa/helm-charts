...
commonimages:
  ...
  brokers:
    image:
      tag: 1.3.0-20181207T170749Z-TryBuy-TKAI-B6XHUQ
  cemusers:
    image:
      tag: 1.3.0-20181206T205554Z-TryBuy-TKAI-B6XHUQ
  channelservices:
    image:
      tag: 1.3.0-20181206T213516Z-TryBuy-TKAI-B6XHUQ
  datalayer:
    image:
      tag: 1.3.0-20181207T003320Z-TryBuy-TKAI-B6XHUQ
  eventanalyticsui:
    image:
      tag: 1.3.0-20181206T205613Z-TryBuy-TKAI-B6XHUQ
  eventpreprocessor:
    image:
      tag: 1.3.0-20181206T205620Z-TryBuy-TKAI-B6XHUQ
  incidentprocessor:
    image:
      tag: 1.3.0-20181206T205629Z-TryBuy-TKAI-B6XHUQ
  notificationprocessor:
    image:
      tag: 1.3.0-20181206T205651Z-TryBuy-TKAI-B6XHUQ
  integrationcontroller:
    image:
      tag: 1.3.0-20181206T205635Z-TryBuy-TKAI-B6XHUQ
  normalizer:
    image:
      tag: 1.3.0-20181206T210900Z-TryBuy-TKAI-B6XHUQ
  schedulingui:
    image:
      tag: 1.3.0-20181206T210810Z-TryBuy-TKAI-B6XHUQ
  rba:
    rbs:
      image:
        tag: 1.14.0-20181207T192700Z-L-TryBuy-TKAI-B6XHUQ
    as:
      image:
        tag: 1.14.0-20181207T192700Z-L-TryBuy-TKAI-B6XHUQ
  cemhelmtests:
    image:
      tag: 0.2.0-20181206T230222Z-TryBuy-TKAI-B6XHUQ
# <-CEM-common-images
#/********************************************************** {COPYRIGHT-TOP} ****
#* Licensed Materials - Property of IBM
#*
...
global: # Properties in here can be accessed by the main chart and by all subcharts
  ...
  persistence:
    enabled: true
    supplementalGroups:
      [] # this is required for NFS storage
