...
###############################################################################
  include-configmap.xml: |-
    <server>
      ...
      <include optional="true" location="/etc/wlp/configmap/iiop-endpoint.xml" onConflict="REPLACE"/>
      <include optional="true" location="/etc/wlp/configmap/iiop-ssl-endpoint.xml" onConflict="REPLACE"/>
...
{{ if and $root.Values.microprofile.health.enabled $root.Values.service.enabled }}
  health.xml: |-
    <server>
      <featureManager>
...
{{ if and $root.Values.isMonitoringEnabled $root.Values.service.enabled }}
  monitoring.xml: |-
    <server>
      <featureManager>
...
{{ if $root.Values.sessioncache.hazelcast.embedded }}
  hazelcast.xml: |-
