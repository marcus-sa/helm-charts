# `@helm-charts/jetstack-cert-manager`
...
| `image.tag`                                     | Image tag                                                                                                                                | `v0.7.0-beta.0`                            |
...
| `webhook.image.tag`                             | Webhook image tag                                                                                                                        | `v0.7.0-beta.0`                            |
...
| `cainjector.image.tag`                          | cainjector image tag                                                                                                                     | `v0.7.0-beta.0`                            |
